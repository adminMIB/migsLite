...
class ArtajasaResponseConverter
{
    public static function inquiryResponse($request)
    {
        return [
            "billerId" => "45950",
            "transId" => [
    ...
    public static function statusResponse($request)
    {
        return [
            "billerId" => "45034",
            "transId" => [
    ...
    public static function reversalResponse($request)
    {
        return [
            "billerId" => "45034",
            "transId" => [
    ...
    public static function paymentResponse($request)
    {
        return [
            "billerId" => "45950",
            "paymentType" => "Close",
