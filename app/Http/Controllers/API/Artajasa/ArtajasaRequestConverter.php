...
class ArtajasaRequestConverter
{
    public static function inquiryRequest($request)
    {
        return [
            "billerId" => "45034",
            "transId" => [
    ...
    public static function statusRequest($request)
    {
        return [
            "billerId" => "45034",
            "transId" => [
    ...
    public static function reversalRequest($request)
    {
        return [
            "billerId" => "45034",
            "transId" => [
    ...
    public static function paymentRequest($request)
    {
        return [
            "billerId" => "45950",
            "paymentType" => "Close",
