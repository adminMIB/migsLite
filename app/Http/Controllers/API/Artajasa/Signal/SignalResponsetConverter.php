...
class SignalResponsetConverter
{
    ...
    public static function payment($request)
    {
        return [
            ...
            "billRefInfo" => [
                "billRef" => "12345654321121234567",
                "additionalInfo1" => null,
                "additionalInfo2" => null
            ],
            "descUI" => null,
            "footer" => "BUKTI E-PENGESAHAN STNK DAPAT DILIHAT PADA APLIKASI SAMSAT DIGITAL NASIONAL/EMAIL. STRUK INI BISA DITUKARKAN DGN TBPKB FISIK DI SAMSAT ATAU CUKUP DILIHAT VERSI DIGITAL PADA APLIKASI/EMAIL"
        ];
    }
}
